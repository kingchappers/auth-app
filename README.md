...
I'll try and deploy this to AWS Cloudfront which should be a very cheap deployment method. I'm yet to decide whether to write the IaC within this repo or have a separate IaC repo, but we'll find out. 
